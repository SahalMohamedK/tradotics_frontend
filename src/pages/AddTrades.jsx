...
import { addTradeHistoryTableAdapter, simpleTableAdapter } from '../adapters/table'
        ...
        <div className='h-full pt-16'>
            <div className='md:flex md:space-x-2  h-full'>
                    <TabBar className='flex flex-wrap md:block mb-2 md:mb-0 mx-2 md:w-1/4 lg:w-1/5' view={mainTV} adapter={iconTabAdapter}>
                        <Tab id='sync' icon={faRotate} label='Sync brocker' active/>
                        ...
                        <Tab id='import'>
                            <Card className='h-full'>                                
                                ...
                                <div className='md:flex md:space-x-2'>
                                    <SelectField className='w-full mb-3' label='Select your brocker / trading platform' icon={faUserTie} values={[
                                        'Binance - Crypto currency'
                                    ]}/>                                
                                    <InputField className='w-full mb-3' label='Import from file' type='file' icon={faFile}/>
                                </div>  
                                <button href="#" className="primary-btn mb-1 mr-1">Save</button>
                            </Card>
                        </Tab>
